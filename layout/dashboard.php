...
<body <?php echo $OUTPUT->body_attributes($additionalclasses = array('home-dashboard')); ?>>
...
<div id="page" class="container-fluid">
    ...
    <?php $PAGE->requires->js( new moodle_url($CFG->wwwroot . '/theme/frankenstein/javascript/dashboard.js')); ?>
</div>
